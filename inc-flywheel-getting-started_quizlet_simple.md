...
comment:  A shortened interactive training course covering INC Flywheel
          ...
          and How to Cite Us. Quiz questions are graded natively by
          LiaScript (no custom scripting). Completion is confirmed via
          a pre-filled email prompt at the end of the course.
