...
Follow our example tutorial using the Flywheel SDK to `download and run analyses locally <notebooks/download-and-run-locally.ipynb>`_.
...
Follow our example tutorial using the Flywheel SDK to `upload my analysis <notebooks/upload-my-analysis.ipynb>`_.
